...
export function MarketSelector({ onClose }: { onClose: () => void }) {
  return (
    <>
      ...
      <div className="absolute left-0 top-[58px] z-50 w-[1170px] max-w-[92vw] overflow-hidden rounded-2xl border border-border bg-card shadow-[0_18px_50px_oklch(0.4_0.04_60/0.18)]">
        <div className="p-4">
